        ...
        >
          {filteredEvents.length > 0 ? (
            filteredEvents.map((event) => {
              ...
              const diaDisplay = event.data_completa
                .split('-')[2]
                .substring(0, 2); // substring garante que pega só "28" e ignora "28T00:00" se houver
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm font-bold text-(--color-secondary) mb-1">
                    {activeMonth}{' '}
                    {/* Usamos a própria variável do botão (ex: FEV) */}
                  </div>
